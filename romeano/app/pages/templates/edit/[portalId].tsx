...
EditTemplatePortal.authenticate = true
EditTemplatePortal.getLayout = (page: React.ReactChild) => <Layout title={`Edit Template Portal`}>{page}</Layout>
export default EditTemplatePortal
