...
function ProgressBullets(props: { portalId: string; current: number; total: number }) {
  return (
    <div className="flex items-center" aria-label="Progress">
      {range(props.total).length > 0 ? (
        ...
        <span className="text-xs text-gray-600">
          <BlitzLink href={Routes.EditCustomerPortal({ portalId: props.portalId })}>
            <a className="inline-flex items-center text-xs">
              Add roadmap stages <ArrowCircleRightIcon className="ml-2 h-4 w-4" />
            </a>
          </BlitzLink>
        </span>
      )}
...
export function ActivePortals(props: {
  ...
  return (
    <>
      <Card className="overflow-hidden" additionalClasses="bg-gray" borderless={true}>
        <CardHeader
              ...
              <div className="">
                <table className="min-w-full divide-y rounded-lg">
                  <thead style={{ backgroundColor: "#F7F7F9" }}>
                    <tr>
                      <th scope="col" className="py-3 text-left text-sm font-light text-gray-500 tracking-wider">
                        Opportunity
                      </th>
                      <th scope="col" className="py-3 text-left text-sm font-light text-gray-500 tracking-wider">
                        Primary Contact
                          ...
                          {portal.primaryContact && (
                            <div className="relative bg-white flex items-center space-x-3">
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs truncate text-gray-600">{portal.primaryContact.jobTitle}</p>
                              </div>
      ...
      <div className="bg-gray py-8"> </div>
    </>
  )
}
